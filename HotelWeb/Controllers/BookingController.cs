...
{
    [Authorize]
    public class BookingController(IUnitOfWork unit, IWebHostEnvironment webHost) : Controller
    {
        ...
        public async Task<IActionResult> GenerateInvoice(int id, string downloadType)
        {
            ...
            //Update  Template
            Booking bookingFromDb = await unit.BookingRepository.GetAsync(x => x.Id == id, includeProperty: "User,Villa");
